...
function App() {
  ...
  return (
    <div className="col-md-12" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* Footer */}
      <footer className="text-center mt-auto" style={{ backgroundColor: 'lightgrey', padding: '10px' }}>
